...
public class ParallaxLayerX extends Entity {
	// ===========================================================
	// Constants
	// ===========================================================
	...
	private final ArrayList<ParallaxEntityX> mParallaxEntities = new ArrayList<ParallaxEntityX>();
	...
	// Constructors
	// ===========================================================
	public ParallaxLayerX() {
	}

	public ParallaxLayerX(final Camera camera, final boolean mIsScrollable){
		this.mCamera = camera;
	...
	public ParallaxLayerX(final Camera camera, final boolean mIsScrollable, final int mLevelWidth){
		this.mCamera = camera;
		this.mIsScrollable = mIsScrollable;
	...
	public void onManagedDraw(GLState pGLState, Camera pCamera) {
		...
		final ArrayList<ParallaxEntityX> parallaxEntities = this.mParallaxEntities;
	...
	public void attachParallaxEntity(final ParallaxEntityX parallaxEntity) {
		this.mParallaxEntities.add(parallaxEntity);
		this.mParallaxEntityCount++;
	}

	public boolean detachParallaxEntity(final ParallaxEntityX pParallaxEntity) {
		this.mParallaxEntityCount--;
	...
	public static class ParallaxEntityX {
		// ===========================================================
		// Constants
		// ===========================================================
		...
		public ParallaxEntityX(final float pParallaxFactor, final IShape pAreaShape) {
			this.mParallaxFactor = pParallaxFactor;
			this.mAreaShape = pAreaShape;
			this.mIsScrollable = false;
			shapeWidthScaled = this.mAreaShape.getWidth();
		}
		
		public ParallaxEntityX(final float pParallaxFactor, final IShape pAreaShape, final boolean mIsScrollable) {
			this.mParallaxFactor = pParallaxFactor;
			this.mAreaShape = pAreaShape;
			this.mIsScrollable = mIsScrollable;
			shapeWidthScaled = this.mAreaShape.getWidth();
		...
		public ParallaxEntityX(final float pParallaxFactor, final IShape pAreaShape, final boolean mIsScrollable, final int mReduceFrequency) {
			this.mParallaxFactor = pParallaxFactor;
			this.mAreaShape = pAreaShape;
			this.mIsScrollable = mIsScrollable;
			shapeWidthScaled = this.mAreaShape.getWidth() * mReduceFrequency;
		}
